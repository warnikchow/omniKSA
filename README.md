...
본 레포지토리에서는, 다른 곳에서 잘 다루어지지 않는 한국어의 화행/의도 파악 및 분석에 관한 자연어처리 데이터셋들을 소개하고자 합니다. 언어철학적으로도 오래 연구된 주제인 동시에 산업적으로도 활용성이 높은 내용이지요. 저의 박사과정 research topic이기도 하구요 ㅎㅎ 어느 정도 스토리의 유기성을 위해 옴니버스 형식으로 서술할 예정입니다. 
